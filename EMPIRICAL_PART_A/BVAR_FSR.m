% BVAR_FSR.m
% Code for fast estimation of structural restrictions in Bayesian SVARs. 
%
% This code replicates Figure 2 of Section 4.1, as well as Figures C6-C9 in the online supplement of the paper 
...
% Plot IRFs for Furlanetto, Ravazzolo and Sarferaz (2021) model using conventional algorithm
ylimits = zeros(5,6,2);
for j = 1:5
...
% Next plot model-based IRFs using the new factor sign restrictions algorithm
for j = 1:5
    fullscreen = get(0,'ScreenSize');
    figure('Position',[0 0 fullscreen(3) fullscreen(4)]);  
    for i = 1:6
