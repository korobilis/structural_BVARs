% BVAR_FSR_n_r.m
% Code for fast estimation of structural restrictions in Bayesian SVARs. Compared to baseline case we assume n=r=6
% without placing any restrictions to this sixth shock.
%
% This code replicates panel (b) of Figure 3 of Section 4.1 of the paper Korobilis, Dimitris (2022), "A new algorithm 
...
%1=positive, -1=negative, 0=zero restriction,  NaN=no restriction
      %S1   S2   S3   S4   S5   S6
sg = [  1    1   -1    1    1  NaN;    % VAR EQ1
       -1    1   -1    1    1  NaN;    % VAR EQ2
      NaN    1    1    1    1  NaN;    % VAR EQ3
      NaN   -1  NaN    1    1  NaN;    % VAR EQ4
        1  NaN  NaN   -1    1  NaN;    % VAR EQ5
      NaN  NaN  NaN  NaN  NaN  NaN];   % VAR EQ6
       
sg0 = sg; 
sg0(isnan(sg0)) = 0;
shock_names = {'Supply';'Demand';'Monetary';'Investment';'Financial';'Other'};
...
for j = 1:6
    ...
    pngname = ['FACTOR_nr' num2str(j) '.png'];
    saveas(gcf,pngname);
end
